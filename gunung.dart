...
import 'booking.dart';
import 'keranjang.dart'; // IMPORT FILE KERANJANG

class PesanTiketGunungPage extends StatefulWidget {
  const PesanTiketGunungPage({super.key});

  @override
  State<PesanTiketGunungPage> createState() => _PesanTiketGunungPageState();
}

class _PesanTiketGunungPageState extends State<PesanTiketGunungPage> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.terrain, color: Colors.white, size: 16),
                    const SizedBox(width: 5),
                    Text(
                      item['ketinggian'],
