...
import 'beranda.dart'; // Pastikan file ini ada

class RegisterScreen extends StatelessWidget {
  const RegisterScreen({super.key});

  // Fungsi untuk menangani klik pada tombol sosial media
  void _handleSocialSignUp(BuildContext context, String provider) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Mendaftar menggunakan $provider...'),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(hint: 'Konfirmasi Kata Sandi', isPassword: true),
  ...
  // Widget pendukung untuk Ikon Sosial Media (dengan Network Image)
  Widget _socialIcon({
    ...
    return InkWell(
      onTap: () => _handleSocialSignUp(context, label),
      ...
      child: Container(
        ...
        child: Image.network(
          ...
          // Menampilkan loading saat gambar sedang didownload
