...
class PesanTiketDanauPage extends StatefulWidget {
  const PesanTiketDanauPage({super.key});

  @override
  State<PesanTiketDanauPage> createState() => _PesanTiketDanauPageState();
}

class _PesanTiketDanauPageState extends State<PesanTiketDanauPage> {
  // --- DATA MASTER DANAU DENGAN TAMBAHAN KEDALAMAN & STATUS ---
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // IMPLEMENTASI REKOMENDASI POSISI: KEDALAMAN, STATUS, KATEGORI
                  Row(
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    const Icon(
                      Icons.straighten, // Ikon penggaris/kedalaman
                      color: Colors.white,
                      size: 16,
                    ),
                    const SizedBox(width: 5),
                    Text(
                      item['kedalaman'], // Menampilkan data Kedalaman
